    ...
    <div class="overflow-hidden" ...attributes {{didInsert this.onInit}}>
      <div class="flex justify-end mb-2">
        <button
          ...
          type="button"
          class="btn-press hover:bg-gray-300 text-purple-primary active:bg-gray-400 focus:outline-hidden flex items-center px-4 py-2 text-xs font-bold tracking-wider uppercase border-2 border-gray-200 rounded-full shadow-lg"
