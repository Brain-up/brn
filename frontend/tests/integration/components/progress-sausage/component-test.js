...
module('Integration | Component | progress-sausage', function (hooks) {
  ...
  test('it renders', async function (assert) {
    ...
    assert.dom('[data-test-progress-sausage]').hasAttribute('style', 'width:50%;');
    ...
    assert.dom('[data-test-progress-sausage]').hasAttribute('style', 'width:0%;');
    ...
    assert.dom('[data-test-progress-sausage]').hasAttribute('style', 'width:100%;');
  });
});
