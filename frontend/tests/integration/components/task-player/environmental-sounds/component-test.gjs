  ...
  answerOptions: [
    {
      ...
      word: 'дождь',
      wordType: 'OBJECT',
      pictureFileUrl: 'pictures/дождь.jpg',
      soundsCount: 0,
      description: '',
      columnNumber: -1,
    },
    {
      ...
      word: 'ветер',
      wordType: 'OBJECT',
      pictureFileUrl: 'pictures/ветер.jpg',
      soundsCount: 0,
      description: '',
      columnNumber: -1,
    },
...
module(
  'Integration | Component | task-player/environmental-sounds',
  function (hooks) {
    ...
    hooks.beforeEach(async function () {
      ...
      let model = store.createRecord('task/environmental-sounds', {
        ...schemaData(task),
    ...
    test('it renders answer options', async function (assert) {
      ...
      assert.dom('[data-test-task-answer-option="дождь"]').exists();
      assert.dom('[data-test-task-answer-option="ветер"]').exists();
    });
