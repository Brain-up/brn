...
class TaskControllerTest {
    ...
    inner class GetTasks {
        ...
        fun `should get task by id`() {
            // GIVEN
            val taskId = LONG_ONE
            val task = TaskDto(id = LONG_ONE, serialNumber = INTEGER_ONE, exerciseId = LONG_ONE)
        ...
        fun `should get tasks by exerciseId`() {
            ...
            val taskFirst = TaskDto(id = LONG_ONE, serialNumber = INTEGER_ONE, exerciseId = LONG_ONE)
            val taskSecond = TaskDto(id = 2L, serialNumber = INTEGER_TWO, exerciseId = LONG_ONE)
