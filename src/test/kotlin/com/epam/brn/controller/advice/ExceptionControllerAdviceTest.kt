...
internal class ExceptionControllerAdviceTest {
    ...
    fun `should handle EntityNotFoundException`() {
        ...
        // THEN
        assertTrue((responseEntity.body as Response).errors.toString().contains("tasks were not found"))
    ...
    fun `should handle MethodArgumentNotValidException`() {
        ...
        // THEN
        assertTrue(
            (responseEntity.body as Response).errors.containsAll(
                listOf(
        ...
        assertNotNull((responseEntity.body as Response).errors)
    ...
    fun `should handle CsvFileParseException`() {
        ...
        // THEN
        assertTrue((responseEntity.body as Response).errors.toString().contains("Csv file parsing exception"))
        assertEquals(HttpStatus.BAD_REQUEST, responseEntity.statusCode)
        assertEquals(MediaType.APPLICATION_JSON, responseEntity.headers.contentType)
    }
    ...
    fun `should handle IllegalArgumentException`() {
        ...
        // THEN
        assertTrue((responseEntity.body as Response).errors.toString().contains("IllegalArgumentException"))
        assertEquals(HttpStatus.BAD_REQUEST, responseEntity.statusCode)
        assertEquals(MediaType.APPLICATION_JSON, responseEntity.headers.contentType)
    }
    ...
    fun `should handle BadCredentialsException`() {
        ...
        // THEN
        assertTrue((responseEntity.body as Response).errors.toString().contains("Forbidden"))
    ...
    fun `should handle FileFormatException`() {
        ...
        assertEquals(MediaType.APPLICATION_JSON, responseEntity.headers.contentType)
        assertTrue(
            (responseEntity.body as Response).errors
    ...
    fun `should make InternalServerErrorResponseEntity`() {
        ...
        // THEN
        assertTrue((responseEntity.body as Response).errors.toString().contains("some test exception"))
        assertEquals(HttpStatus.INTERNAL_SERVER_ERROR, responseEntity.statusCode)
        assertEquals(MediaType.APPLICATION_JSON, responseEntity.headers.contentType)
    }
