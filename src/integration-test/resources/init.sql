...
-- INSERT INTO public.exercise_group (id, description, name) VALUES (1, 'Неречевые упражнения', 'Неречевые упражнения');
-- INSERT INTO public.exercise_group (id, description, name) VALUES (2, 'Речевые упражнения', 'Речевые упражнения');