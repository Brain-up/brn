...
@Service
class UserAnalyticsServiceV1Impl(private val userAnalyticsRepository: UserAnalyticsRepository) :
    UserAnalyticsServiceV1 {

    override fun getUsersWithAnalytics(pageable: Pageable, role: String): List<UserWithAnalyticsResponse> =
        userAnalyticsRepository.getUserAnalytics(pageable, role).map {
