...
@Component
class SubGroupGenericRecordMappingIteratorProvider : MappingIteratorProvider<SubgroupGenericRecord> {
    ...
    override fun isApplicable(format: String): Boolean = SubgroupGenericRecord.FORMAT == format
}
