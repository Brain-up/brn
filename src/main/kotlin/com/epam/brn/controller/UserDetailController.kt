...
class UserDetailController(
    ...
    fun findUserById(@PathVariable("userId") id: Long): ResponseEntity<BaseResponse<List<UserAccountResponse>>> {
    ...
    fun updateCurrentUser(@Validated @RequestBody userAccountChangeRequest: UserAccountChangeRequest) =
        ResponseEntity.ok()
            .body(BaseResponse(data = userAccountService.updateCurrentUser(userAccountChangeRequest)))
    ...
    fun updateAvatarCurrentUser(
        ...
        .body(BaseResponse(data = userAccountService.updateAvatarForCurrentUser(avatar)))
    ...
    fun addHeadphonesToUser(
        ...
        .body(BaseResponse(data = userAccountService.addHeadphonesToUser(userId, headphones)))
    ...
    fun addHeadphonesToCurrentUser(@Validated @RequestBody headphones: HeadphonesDto) =
        ResponseEntity.status(HttpStatus.CREATED)
            .body(BaseResponse(data = userAccountService.addHeadphonesToCurrentUser(headphones)))
    ...
    fun deleteHeadphonesForCurrentUser(
        ...
        return ResponseEntity.ok(BaseResponse(data = Unit))
    }
    ...
    fun getDoctorAssignedToPatient(@PathVariable patientId: Long) =
        ResponseEntity.ok()
            .body(BaseResponse(data = doctorService.getDoctorAssignedToPatient(patientId)))
