...
class ExerciseController(@Autowired val exerciseService: ExerciseService) {
    ...
    fun getExercisesBySubGroup(@RequestParam(value = "subGroupId", required = true) subGroupId: Long): ResponseEntity<BaseResponse> {
    ...
    fun getExercisesByID(
        ...
        return ResponseEntity.ok()
            .body(BaseSingleObjectResponse(data = exerciseService.findExerciseById(exerciseId)))
    }
