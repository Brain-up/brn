...
class StudyHistoryController(
    ...
    ): ResponseEntity<StudyHistoryDto> = ResponseEntity.ok().body(studyHistoryService.save(studyHistoryDto))
    ...
    fun getTodayWorkDurationInSeconds(): ResponseEntity<BrnResponse<Int>> =
        ResponseEntity.ok().body(BrnResponse(data = studyHistoryService.getTodayTimer()))
